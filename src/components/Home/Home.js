    ...
    return (
        <>
            ...
            <main>
                ...
                <div style={{ backgroundColor:"#f4f4f4b9", paddingTop:"20px", paddingBottom:"40px"}}>
                    <GalleryContainer />
                </div>
                <div id="contact-container" data-aos="fade-in" data-aos-duration="3000" data-aos-delay="400">
                    <h1>Kontakt</h1>
                    <p className="count">89</p>
